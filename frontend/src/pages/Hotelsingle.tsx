...
const slideList: SlideItem[] = [
    { imageUrl: 'hotel.png', name: 'product-image' },
    { imageUrl: 'hotel.png', name: 'product-image' },
    { imageUrl: 'hotel.png', name: 'product-image' },
    { imageUrl: 'hotel.png', name: 'product-image' }
];

const TabOne: TabItem[] = [
    { image: '01', bigImage: 'assets/images/hotel.png' },
    { image: '02', bigImage: 'assets/images/hotel.png' },
    { image: '03', bigImage: 'assets/images/hotel.png' },
    { image: '04', bigImage: 'assets/images/hotel.png' },
    { image: '05', bigImage: 'assets/images/hotel.png' },
    { image: '06', bigImage: 'assets/images/hotel.png' }
];
...
const Hotelsingle: React.FC = () => {
    ...
    const slides = TabOne.map((item) => ({ src: item.bigImage }));
                            ...
                            <div className="col-xl-8 col-xxl-9 col-lg-8">
                                <div className="card d-block mt-3 border-0 shadow-xss bg-white p-lg-5 p-4">
                                    ...
                                    <h2 className="fw-700 font-lg mt-3 mb-2">
                                        House Party Graynight Mood In Silver Colony, London
                                    </h2>
                                    <p className="font-xsss fw-500 text-grey-500 lh-30 pe-5 mt-3 me-5">
                                        ultrices justo eget, sodales orci. Aliquam egestas libero ac turpis pharetra, in vehicula lacus
                                        scelerisque. Vestibulum ut sem laoreet, feugiat tellus at, hendrerit arcu.
                                    </p>

                                    <div className="star d-block w-100 text-left mt-2">
                                        {[...Array(4)].map((_, i) => (
                                            <img key={i} src="assets/images/star.png" alt="star" className="w15 float-left" />
                                        ))}
                                    ...
                                    <a href="/defaulthoteldetails" className="btn-round-lg ms-2 d-inline-block rounded-3 bg-greylight">
                                        <i className="feather-share-2 font-sm text-grey-700"></i>
                                    </a>
                                    <a href="/defaulthoteldetails" className="btn-round-lg ms-2 d-inline-block rounded-3 bg-danger">
                                    ...
                                    <div className="row ps-3 pe-3">
                                        {TabOne.map((value, index) => (
                                            <div className="col-sm-4 col-xss-4 pe-1 ps-1 mb-2" key={index}>
                                                ...
                                                >
                                                    <img src={value.bigImage} alt="Gallery" className="w-100 rounded-3" />
                                                </div>
                                            </div>
                                        ))}
                                    </div>
