                        ...
                        <div className="row">
                            <div className="col-xl-8 col-xxl-9 col-lg-8">
                                <div className="card border-0 mb-0 rounded-3 overflow-hidden chat-wrapper bg-image-center bg-image-cover"
                                    style={{ backgroundImage: `url("assets/images/login.svg")` }}>
                                    <div className="card-body position-absolute mt-0 ms-0 left-0">
                                        <img src="assets/images/user.png" alt="video-bg" className="w150 h200 rounded-3 position-relative z-index-1 shadow-xss" />
                                    </div>
