                        ...
                        <div className="row justify-content-center">
                            <div className="col-xl-10">
                                        ...
                                        <div className="form-group w-lg-75 mt-4 border-light border p-1 bg-white rounded-3 ms-auto me-auto">
                                            <div className="row">
                                                ...
                                                <div className="col-md-4">
                                                    <Link to="helpbox" className="w-100 d-block btn bg-current text-white font-xssss fw-600 ls-3 style1-input p-0 border-0 text-uppercase ">Search</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="card w-100 border-0 shadow-none bg-transparent mt-5">
                                    <div className="accodion-style--1 accordion space-y-4">
                                        {/* Accordion Item 1 */}
                                        <Disclosure defaultOpen>
                                            {({ open }) => (
                                                <div className="card shadow-xss">
                                                    <Disclosure.Button className="card-header w-full text-left border-0">
                                                        <h5 className="fw-600 pt-2 pb-2 mb-0">
                                                            I have read and agree to the Privacy Policy and Terms & Conditions*
                                                        </h5>
                                                    </Disclosure.Button>
                                                    <Disclosure.Panel className="card-body">
                                                        <p>
