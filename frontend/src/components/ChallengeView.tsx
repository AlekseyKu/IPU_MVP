      ...
      >
            ...
            {isOwnProfile && !isList && (
              <div className="d-flex justify-content-end align-items-center mb-1">
                <span className="text-muted font-xssss me-1">
                  {challenge.is_public ? "Публичное" : "Личное"}
                </span>
            ...
            {challenge.frequency && challenge.total_reports && (
              <div className="d-flex justify-content-between align-items-center">
                <div className="text-muted font-xsss mb-1">
                  ...
                  Прогресс: {challenge.completed_reports}/
        ...
        {isOpen && (
          <div className="mt-3" onClick={(e) => e.stopPropagation()}>
            ...
            {/* Кнопка "Посмотреть результат" для завершённых челленджей */}
            {is_completed && (
              <div className="d-flex justify-content-center py-2">
                <button
                  className="btn w-50 btn-outline-primary"
            ...
            <div className="mb-2">
              ...
              <div className="p-2">
                {activeTab === "progress" ? (
                  <div>
                    {reports.length === 0 && (
                      <div className="text-muted font-xsss">Нет отчетов</div>
                    )}
                    ...
                    onClick={() => {
                      if (navigator.share) {
                        navigator
                          ...
                          .catch(console.error);
                      } else alert("Поделиться недоступно");
                      setMenuOpen(false);
                    }}
                  >
                    Отправить
