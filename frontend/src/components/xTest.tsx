...
//             <img src={avatarUrl || '/assets/images/defaultAvatar.png'} alt="avatar" width={32} height={32} className="rounded-circle me-2" />
//           </Link>
...
//           <span className="text-muted small">Создано: {new Date(created_at).toLocaleString()}</span>
