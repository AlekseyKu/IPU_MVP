...
const newDemoList: DemoItem[] = [
    { imageUrl: 'home.jpg', title: 'Home', url: 'home' },
    { imageUrl: 'badge.jpg', title: 'Badge', url: 'defaultbadge' },
    { imageUrl: 'member.jpg', title: 'Member', url: 'defaultmember' },
    { imageUrl: 'story.jpg', title: 'Storie', url: 'defaultstorie' },
    { imageUrl: 'group.jpg', title: 'Group', url: 'defaultgroup' },
    { imageUrl: 'group-page.jpg', title: 'Group Page', url: 'grouppage' },
    { imageUrl: 'user.jpg', title: 'User', url: 'userpage' },
    { imageUrl: 'author.jpg', title: 'Group', url: 'authorpage' },
    { imageUrl: 'email.jpg',title: 'Email',url: 'defaultemailbox' },
    { imageUrl: 'email-open.jpg',title: 'Email Open',url: 'defaultemailopen' },
    { imageUrl: 'message.jpg',title: 'Message',url: 'defaultmessage' },
    { imageUrl: 'job.jpg',title: 'Job',url: 'defaultjob' },
    { imageUrl: 'hotel.jpg',title: 'Hotel',url: 'defaulthotel' },
    { imageUrl: 'hotel-open.jpg',title: 'Hotel Page',url: 'defaulthoteldetails' },
    { imageUrl: 'event.jpg',title: 'Event',url: 'defaultevent' },
    { imageUrl: 'live.jpg',title: 'Live',url: 'defaultlive' },
    { imageUrl: 'noti.jpg',title: 'Notification',url: 'defaultnotification' },
    { imageUrl: 'video.jpg',title: 'Video',url: 'defaultvideo' },
    { imageUrl: 'analytics.jpg',title: 'Analytics',url: 'defaultanalytics' },    
    { imageUrl: 'shop-3.jpg',title: 'Shop One',url: 'shop1' },
    { imageUrl: 'shop-1.jpg',title: 'Shop two',url: 'shop2' },    
    { imageUrl: 'cart.jpg',title: 'Cart',url: 'cart' },
    { imageUrl: 'checkout.jpg',title: 'Checkout',url: 'checkout' },
    { imageUrl: 'single-product.jpg',title: 'Single Product 2',url: 'singleproduct' },
    ...
    { imageUrl: 'coming-soon.jpg',title: 'Coming Soon',url: 'comingsoon' },
    { imageUrl: '404.jpg',title: '404',url: 'notfound' },
    { imageUrl: 'help-box.jpg',title: 'Help',url: 'helpbox' },
    { imageUrl: 'd-17.jpg',title: 'Settings',url: 'defaultsettings' },
    { imageUrl: 'd-15.jpg',title: 'Contact',url: 'contactinformation' },
    { imageUrl: 'd-16.jpg',title: 'Account',url: 'accountinformation' },
    { imageUrl: 'd-19.jpg',title: 'Payment',url: 'payment' },
    { imageUrl: 'd-18.jpg',title: 'Password',url: 'password' },
    { imageUrl: 'd-20.jpg',title: 'Social',url: 'socialaccount' },
];
                        ...
                        <div className="row">
                            <div className="col-lg-5 col-md-6 col-sm-8">
                                <h2 className="title-text mb-5 mt-5">
                                    <b>Set up your <span>Social</span> website with Sociala.</b>
                                </h2>
                                ...
                                <Link to="#demo" className="btn btn-lg btn-primary mr-4 text-uppercase mt-5">See DEMOs</Link>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-5 offset-lg-1">
                            ...
                            <p>Sociala powers thousands of apps at some of the smartest companies around the world. Be a part of professional community.</p>
                            <Link to="#demo" className="btn btn-lg btn-primary mr-4 text-uppercase mt-4">Components</Link>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-5 mt-5 mb-5">
                                    ...
                                    <Link to="/" className="btn btn-lg btn-primary mr-4 text-uppercase mt-4">See Demo</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        {newDemoList.map((value, index) => (
                            <div key={index} className="col-lg-4 col-md-6 demo-item">
                                <Link to={`/${value.url}`}>
                                    <img src={`../assets/images/demo/${value.imageUrl}`} alt={value.title} className="w-100" />
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-6 text-center">
                            ...
                            <div className="col-sm-12 text-center mt-5"><Link to="/" className="btn-lg btn bg-white">PURCHASE NOW</Link></div>
                        </div>
                    </div>
                </div>
            </div>
