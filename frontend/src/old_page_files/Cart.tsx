                                ...
                                <div className="row">
                                    <div className="col-lg-8 mb-3">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td className="product-thumbnail text-left ps-0">
                                                            <img src="assets/images/story.png" alt="Product Thumnail" className="w75 rounded-3" />
                                                        </td>
                                                        <td className="product-headline text-left wide-column">
                                                            <h3>
                                                                <Link to="/cart" className="text-grey-900 fw-600 font-xsss">Super skinny blazer</Link>
                                                            </h3>
                                                        </td>
                                                        ...
                                                        <td className="product-remove text-right"><Link to="/cart"><i className="ti-trash font-xs text-grey-500"></i></Link></td>
                                                    </tr>
                                                    <tr>
                                                        <td className="product-thumbnail text-left ps-0">
                                                            <img src="assets/images/story.png" alt="Product Thumnail" className="w75 rounded-3" />
                                                        ...
                                                        <td className="product-headline text-left wide-column">
                                                            <h3>
                                                                <Link to="/cart" className="text-grey-900 fw-600 font-xsss"> Jogging trousers</Link>
                                                            </h3>
                                                        </td>
                                                        <td className="product-p">
                                                            <span className="product-price-wrapper">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="product-headline text-left wide-column">
                                                            <h3>
                                                                <Link to="/cart" className="text-grey-900 fw-600 font-xsss"> Grey blue leather backpack</Link>
                                                            </h3>
                                                        </td>
                                                        <td className="product-p">
                                                            <span className="product-price-wrapper">
                                        ...
                                        <div className="coupon float-left mb-2">
                                            ...
                                            <Link to="/cart" className="bg-dark text-white fw-600 text-uppercase font-xssss border-dark border rounded-3 border-size-md d-inline-block w175 p-3 text-center ls-3">Apply Coupon</Link>
                                        </div>
                                        <Link to="/cart" className="update-cart bg-dark float-right text-white fw-600 text-uppercase font-xssss border-dark border rounded-3 border-size-md d-inline-block w175 p-3 text-center ls-3">Update Cart</Link>
                                    </div>
